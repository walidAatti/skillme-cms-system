        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/">
                        <x-application-logo src="{{ asset('images/logo.png') }}" alt="logo" class="block h-9 w-auto fill-current text-gray-800" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="space-x-4">
                        ...
                        <a href="{{ route('register') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium">
                            {{ __('Register') }}
                        </a>
                    </div>
                @endauth
